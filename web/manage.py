...
from web.app.models.document import Contact
...
def seed_db():
    ...
    # db.session.add(BlogEntry(name='Moosu',message='test-tw-db',email="moosu@gmu.ac.th", avatar_url='https://ui-avatars.com/api/?name=moosu&background=83ee03&color=fff'))

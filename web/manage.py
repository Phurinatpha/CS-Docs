...
def seed_db():
    ...
    db.session.add(
        order_info(subject='ฮัลโหลนี่คือข้อมูลจาก database จะขึ้นไหมน้าา', doc_path='d/ss', doc_date='32 ก.ค. 2566',ref_num='99/2566',ref_name='Mr. Compsci ChiangMai University',user_id='1'))
    db.session.add(
        order_info(subject='จริงๆแล้วฉันหนะ คือประธานบริษัทก่อสร้าง', doc_path='d/ss', doc_date='33 ก.ค. 2566',ref_num='99/2566',ref_name='นาย นึกว่ายาม หัวหน้านี่หว่า',user_id='1'))
    db.session.add(
        order_info(subject='คิดจะพัก คิดถึงคิดแคท', doc_path='d/ss', doc_date='34 ก.ค. 2566',ref_num='99/2566',ref_name='นาย คิทแคท หวานเจี้ยบ',user_id='1'))
    db.session.add(
        order_info(subject='คิดสิ คิดสิ คาปูชิโน่วว เอสเปรสโซ่วว อาราบิก๊าา', doc_path='d/ss', doc_date='35 ก.ค. 2566',ref_num='99/2566',ref_name='นายกาแฟดํา เพิ่มชอต',user_id='1'))

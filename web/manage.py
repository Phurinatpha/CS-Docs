...
def seed_db():  
    ...
    db.session.add(
        order_info(subject='แต่งตั้งคณะกรรมการสอบปริญญานิพนธ์  นายกอไก่ ออกไข่  630510204', doc_date='2566-10-23',ref_num=8,ref_year='2566',ref_name=['ธีรภัทร์ นิลศิริ'],user_id='2'))
    db.session.add(
        order_info(subject='แต่งตั้งคณะกรรมการคุมสอบกลางภาค ประจำภาคเรียนที่ 1 ปีการศึกษา 2566', doc_date='2566-11-5',ref_num=9,ref_year='2566',ref_name=['แสงตะวัน ภู่พุ่ม'],user_id='1'))
    db.session.add(
        order_info(subject='เปลี่ยนแปลงคณะกรรมการบริหารหลักสูตรระดับปริญญาตรี ประจำสาขาวิทยาการคอมพิวเตอร์', doc_date='2566-11-29',ref_num=10,ref_year='2566',ref_name=['แสงตะวัน ภู่พุ่ม'],user_id='1'))
    db.session.commit()
